...
-- 	Skys Upscent
SET @GOB_INSTANCE_SKYSUPSCENT = @OBJ_GUID_START + 300; 
SET @CREATURE_INSTANCE_SKYSUPSCENT = @CREATURE_GUID_START + 300;

-- Lifebinders Way
SET @GOB_INSTANCE_LIFEBINDER = @OBJ_GUID_START + 550; 
SET @CREATURE_INSTANCE_LIFEBINDER = @CREATURE_GUID_START + 550;
